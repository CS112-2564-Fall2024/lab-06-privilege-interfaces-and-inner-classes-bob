...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Person p1 = new Person("Amira", new Person.Identity("She/Her", "Syrian refugee"), 40);
        Person p2 = new Person("D'Andra", new Person.Identity("She/Her", "African-American trans woman"), -20);
        Person p3 = new Person("Jennifer", new Person.Identity("She/Her", "New Yorker"), 140);
        Person p4 = new Person("Pete", new Person.Identity("He/Him", "Guy from Pennsylvania"), 200);
                ...
                case 3:
                    for (Person person : people) {
                        if (person != self) {
                            ...
                            if (comparison > 0) {
                                System.out.println(self.getName() + " has more privilege than " + person.getName());
                            } else if (comparison < 0) {
                                System.out.println(self.getName() + " has less privilege than " + person.getName());
                            } else {
                                System.out.println(self.getName() + " has the same privilege as " + person.getName());
                            }
                        }
                    }
                    System.out.println("\nReturning to main menu.\n");
    ...
    public static void fillInfo(Person person) {
        ...
        // Adding prompts for pronouns and background
        System.out.println("\nPlease enter your preferred pronouns (e.g., She/Her, He/Him, They/Them): ");
        pronouns = keyboard.nextLine();
        System.out.println("\nPlease provide a brief background (e.g., nationality, ethnicity, gender, etc.): ");
        background = keyboard.nextLine();

        person.setName(name);
        person.setStory(new Person.Identity(pronouns, background)); // Store pronouns and background as Identity
    }
